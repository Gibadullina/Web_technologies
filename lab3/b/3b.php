...
<div class="form_box">
  ...
  выразить благодарность или задать любые интересующие Вас вопросы!</p>
   <form name="user" id="form1">
     <br> Ваше имя:
     <input class="rfield" type="text" name="f" size="30" required="required"> 
	 <br> Ваш e-mail:
	 <input class="rfield" id="ml"  type="email" name="e" size="35" required="required">
	 <br> Текст сообщения:<br>
	<!-- <input type="text" class="rfield" id="letter" name="text"  cols="33" rows="8"></textarea>-->
<textarea class="rfield" id="letter" name="text"  cols="33" rows="8" required="required" ></textarea>	
 <br>
     <input type="submit" id="button1" value="Отправить" >
   </form> 
 </div>
